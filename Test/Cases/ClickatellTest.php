...
class ClickatellTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testRequestCreated()
    {
        ...
        $this->assertInstanceOf("Clickatell\Component\Request", $clickatell->request());
    }
    ...
    public function testInitialTransport()
    {
        ...
        $this->assertInstanceOf("Clickatell\Component\Transport\TransportHttp", $clickatell->getTransport());
    }
